...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_ADV_BUF_COUNT, 32);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_TX_SEG_MSG_COUNT, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_RX_SEG_MSG_COUNT, 32);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DEVICE_IS_MASTER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_CHAT_CLI_MESSAGE_LENGTH, 20);
